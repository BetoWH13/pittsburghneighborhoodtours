  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-600 mb-10 max-w-2xl">
        Comprehensive guides to help you plan your Pittsburgh adventure, from
        where to stay to how to get around.
      </p>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {posts.map((post) => (
          ...
          >
            <div className="bg-gradient-to-r from-gold to-yellow-400 h-2" />
            <div className="p-6">
